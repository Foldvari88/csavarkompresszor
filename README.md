...
- `CONSULTATION_NOTIFICATION_TO`: konzultációs visszahívás kattintások értesítési címe, alapértelmezetten `info@iparikompresszor.hu`
...
Az eredmény és follow-up emailek konzultációs CTA-ja saját tracking route-ra megy. Kattintás után az app elküldi a belső visszahívás-kérés értesítést a `CONSULTATION_NOTIFICATION_TO` címre, majd a `https://iparikompresszor.hu/konzultaciokeres` köszönő oldalra irányít.
...
- `CONSULTATION_NOTIFICATION_TO=info@iparikompresszor.hu`
